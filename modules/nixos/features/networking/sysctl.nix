...
in
{
  config = lib.mkIf cfg.enable {
    boot.kernel.sysctl = {
      ...
      # Fair Queue packet scheduler settings
      "net.core.default_qdisc" = "fq"; # Enable Fair Queue packet scheduler
      "net.ipv4.tcp_notsent_lowat" = 16384; # Limit outstanding data to 16KB
      "net.ipv4.tcp_pacing_ss_ratio" = 200; # More conservative pacing in slow start
      "net.ipv4.tcp_pacing_ca_ratio" = 120; # More conservative pacing in congestion avoidance
    };
  };
}
